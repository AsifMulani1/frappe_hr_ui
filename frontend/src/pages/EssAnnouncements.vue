      ...
      <div class="flex flex-col gap-5">
        <Card v-for="p in posts" :key="p.id">
          ...
          <div class="mt-4 flex items-center gap-5 border-t border-outline-gray-1 pt-3.5 text-[13px] font-medium text-ink-gray-6">
            <button class="inline-flex items-center gap-1.5"><Icon name="gift" :size="16" /> Acknowledge</button>
            <button class="inline-flex items-center gap-1.5"><Icon name="external" :size="15" /> Share</button>
          </div>
        </Card>
